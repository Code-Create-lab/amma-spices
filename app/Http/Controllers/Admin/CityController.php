...
class CityController extends Controller
{
    ...
    public function citylist(Request $request)
    {
        ...
        return view('admin.city.citylist', compact('title', 'city', 'admin', 'logo', 'url_aws'));
    }
    ...
    public function city(Request $request)
    {
        ...
        return view('admin.city.cityadd', compact('title', 'city', 'admin', 'logo', 'url_aws'));
    }
    ...
    public function cityedit(Request $request)
    {
        ...
        return view('admin.city.cityedit', compact('title', 'city', 'admin', 'logo', 'url_aws'));
    }
