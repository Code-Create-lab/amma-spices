...
class DeliveryController extends Controller
{
    ...
    public function AddD_boy(Request $request)
    {
        ...
        return view('admin.d_boy.add', compact("d_boy", "admin_email", "logo", "admin", "title", 'city', 'mapset', 'server_key', 'stores', 'id_types', 'url_aws'));
    }
    ...
    public function boy_reports(Request $request)
    {
        ...
        return view('admin.d_boy.d_boy_report', compact('title', "admin", "logo", 'dboy', 'orddboy', 'store', 'ordstore', 'user', 'user2', 'url_aws'));
    }
}
