...
class ProfileController extends Controller
{
    ...
    public function adminProfile(Request $request)
    {
        ...
        return view('admin.profile.profile', compact("admin_email", "admin", 'logo', "title", "url_aws"));
    }
    ...
    public function adminChangePass(Request $request)
    {
        ...
        return view('admin.profile.change_pass', compact("admin_email", "admin", "logo", "title", "url_aws"));
    }
