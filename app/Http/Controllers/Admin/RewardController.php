...
class RewardController extends Controller
{
    ...
    public function RewardList(Request $request)
    {
        ...
        return view('admin.reward.rewardlist', compact('title', 'reward', 'admin', 'logo', 'url_aws'));
    }
    ...
    public function reward(Request $request)
    {
        ...
        return view('admin.reward.rewardadd', compact('title', 'reward', 'admin', 'logo', 'url_aws'));
    }
    ...
    public function rewardedit(Request $request)
    {
        ...
        return view('admin.reward.rewardedit', compact('title', 'reward', 'admin', 'logo', 'url_aws'));
    }
