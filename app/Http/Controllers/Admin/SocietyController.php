...
class SocietyController extends Controller
{
    ...
    public function societylist(Request $request)
    {
        ...
        return view('admin.society.societylist', compact('title', 'city', 'logo', 'admin', "url_aws"));
    }
    ...
    public function society(Request $request)
    {
        ...
        $mapbox = DB::table('mapbox')
            ->first();
        $url_aws = $this->getImageStorage();
        return view('admin.society.societyadd', compact('title', 'city', 'admin', 'logo', 'map', 'mapset', 'mapbox', 'url_aws'));
    }
    ...
    public function societyedit(Request $request)
    {
        ...
        $mapbox = DB::table('mapbox')
            ->first();
        $url_aws = $this->getImageStorage();
        return view('admin.society.societyedit', compact('title', 'city', 'cities', 'admin', 'logo', 'map', 'mapset', 'mapbox', 'url_aws'));
    }
