...
class VarientController extends Controller
{
    ...
    public function varient(Request $request)
    {
        ...
        return view('admin.product.varient.show_varient', compact("admin_email", "product", "admin", "currency", "id", 'title', 'logo', 'url_aws'));
    }
    ...
    public function Editproduct(Request $request)
    {
        ...
        return view('admin.product.varient.editvarient', compact("admin_email", "admin", "product", "varient_id", 'title', 'logo', 'url_aws'));
    }
