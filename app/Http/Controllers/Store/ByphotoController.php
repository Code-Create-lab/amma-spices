...
class ByphotoController extends Controller
{
    ...
    public function user_list(Request $request)
    {
        ...
        return view('store.order_by_photo.user_orderlist', compact('title', "store", "logo", "list", "url_aws"));
    }
    ...
    public function sel_product(Request $request)
    {
        ...
        if (count($check) > 0) {
            ...
            return view('store.order_by_photo.orderbyphoto', compact('title', "store", "logo", "products", "selected", "u", "url_aws"));
        } else {
            $products = DB::table('store_products')
                ->join('product_varient', 'store_products.varient_id', '=', 'product_varient.varient_id')
                ->join('product', 'product_varient.product_id', '=', 'product.product_id')
            ...
            return view('store.order_by_photo.orderbyphoto', compact('title', "store", "logo", "products", "selected", "user_id", "u", "url_aws"));
        }
    }
