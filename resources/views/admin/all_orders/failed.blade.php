            ...
            <div class="col-lg-12">
                <div class="card">
                    ...
                    <div class="container"> <br>
                        <table id="datatableDefault" class="table table-striped table-responsive w-100">
                                           ...
                                           <td>{{ $order->address->receiver_name ?? $order->user?->name  }}<p style="font-size:14px">
                                            ...
                                            <td>
                                                @if (
                                                    ...
                                                    @else
                                                        <b style="color:green">
                                                @endif {{ ucfirst($order->payment_method) }}</b>
                                            </td>
                                                        ...
                                                        <tr>
                                                            <td valign="top" style="width:50%">
                                                                ...
                                                                <strong>{{ __('keywords.Customer_name') }} :
                                                                 ...
                                                                 <strong>{{ __('keywords.Customer_email') }} :
                                                                </strong>{{ $order->address->receiver_email }}<br />
