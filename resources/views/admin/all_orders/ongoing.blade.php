            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header card-header-primary">
                        <h4 class="card-title ">{{ __('keywords.Confirmed_Orders') }}</h4>
                    </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @if ($order->shipment?->status == 'success')
                                                    <a href="{{ route('admin.orders.tracking', $order->order_id) }}"
                                                        target="_blank" class="btn btn-success">Track</a>
                                                @endif
                                            ...
                                            <td>
                                                <a href="{{ route('changeOrderStatusCompleted', $order->order_id) }}"
