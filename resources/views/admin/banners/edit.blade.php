            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header card-header-primary">
                        <h4 class="card-title">{{ __('keywords.Update') }} {{ __('keywords.Banner') }}</h4>
                    </div>

                    <div class="card-body">
                        <form class="forms-sample" action="{{ route('banners.update', $banner->uuid) }}" method="POST"
                            enctype="multipart/form-data" id="banner-update-form">
                            @csrf
