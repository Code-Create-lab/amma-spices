                            ...
                            {{-- <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="type" class="form-control" required>
                                        <option disabled selected>{{ __('keywords.Select') }} {{ __('keywords.Tax') }}
                                        </option>
                        ...
                        <div class="row">
                            ...
                            {{-- <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="tax_per" class="form-control" placeholder="tax percentage"
                                        step="0.01" value="{{ old('tax_per') }}" required>
                                </div>
                            </div> --}}
                        </div>
