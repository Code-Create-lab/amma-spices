...
@section('content')
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header card-header-primary">
                        <h4 class="card-title">{{ __('keywords.Add') }} Child Category</h4>
                        <form id="categoryForm" class="forms-sample" action="{{ route('AddNewCategory') }}" method="post"
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <span id="parentError" style="color:red; display:none;">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <label class="bmd-label-floating">{{ __('keywords.Image') }}
    ...
    <script>
        document.getElementById('categoryForm').addEventListener('submit', function(e) {
            ...
            const errorSpan = document.getElementById('parentError');

            // If select exists AND no value selected
