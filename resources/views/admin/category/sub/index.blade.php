            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header card-header-primary">
                        <div class="row">
                            <div class="col-md-6">
                                <h1 class="card-title"><b>{{ __('keywords.Sub Category') }} {{ __('keywords.List') }}</b>
                                </h1>
                            </div>
                            <div class="col-md-6">
                                <a href="{{ route('AddsubCategory') }}" class="btn btn-primary p-1 ml-auto"
                                    ...
                                    @foreach ($category as $cat)
                                        <tr>
                                            ...
                                            <td class="td-actions text-right">
                                                <a href="{{ route('EditsubCategory', $cat->cat_id) }}" rel="tooltip"
