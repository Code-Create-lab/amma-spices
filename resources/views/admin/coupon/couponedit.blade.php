            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary">
                  <h4 class="card-title">{{ __('keywords.Edit')}} {{ __('keywords.Coupon Details')}}</h4></div>
                            ...
                            <div class="col-md-6">
                              <div class="form-group">
                                ...
                                <select class="form-control form-control-sm img" name="coupon_type" id="coupon_type">
                                  <option value="0" @if($coupon->typecoupon=='0') selected @endif>{{ __('keywords.Reg_Coupon')}}</option>
                                  <option value="1" @if($coupon->typecoupon=='1') selected @endif>{{ __('keywords.Fst_Coupon')}}</option>
                                </select>
                              </div>
                            </div>
                            <div class="col-md-6">
                              <div class="form-group">
                                ...
                                <input type="number" name="restriction" class="form-control" placeholder="{{ __('keywords.coupon_limuses_holder')}}"  min="1" value="{{$coupon->uses_restriction}}" required>
                              </div>
                            </div>
                          </div>
                          <div class="row align-items-end">
                            <div class="col-md-6">
                              <div class="form-group">
                                ...
                                <input type="text" name="coupon_name" class="form-control" value="{{$coupon->coupon_name}}" placeholder="{{ __('keywords.coupon_name_holder')}}" required>
                              </div>
                            </div>
                            <div class="col-md-5">
                              <div class="form-group">
                                <label class="bmd-label-floating">{{ __('keywords.Coupon Code')}}</label>
                                <input type="text" id="coupon_code" name="coupon_code" minlength="5" maxlength="11" class="form-control" placeholder="{{ __('keywords.coupon_code_holder')}}" value="{{$coupon->coupon_code}}" required>
                              </div>
                            </div>
                          ...
                          <div class="row">
                            <div class="col-md-6">
                              <div class="form-group">
                                ...
                                <input type="text" name="coupon_desc" class="form-control" placeholder="{{ __('keywords.coupon_desc_holder')}}" value="{{$coupon->coupon_description}}">
                              </div>
                            </div>
                            {{-- <div class="col-md-6">
                              ...
                              {{-- <div class="col-md-6">
                            <label class="bmd-label-floating">Show on Homepage</label>
                            <div class="">
                                <input type="checkbox" class="-input"  name="show_on_web" {{ ($coupon->show_on_web) ? 'checked' : '' }}/>
                                <label class="-label" for="show_on_web">Show Description on Homepage</label>
                              </div>
                          </div> --}}
                          </div>
                          <div class="row">
                            <div class="col-md-6">
                              <div class="form-group">
                                ...
                                <input type="datetime-local" name="valid_from" class="form-control" value="{{$coupon->start_date}}">
                              </div>
                            </div>
                            <div class="col-md-6">
                              <div class="form-group">
                                <p class="card-description">{{ __('keywords.To Date')}}</p>
                                <input type="datetime-local" name="valid_to" class="form-control" value="{{$coupon->end_date}}">
                              </div>
                            </div>
                          </div>
                            ...
                            <div class="col-md-2">
                              <div class="form-group">
                                ...
                                <select class="form-control img" id="discount_type" name="discount_type" required>
                                  ...
                                  <option value="percent" @if($coupon->type=="percent") selected @endif>{{ __('keywords.Percentage')}}</option>
                                  <option value="amount" @if($coupon->type=="amount") selected @endif>{{ __('keywords.Price')}}</option>
                                </select>
                              </div>
                            </div>
                            <div id="coupon_discount" class="col-md-4 align-self-center mt-md-3">
                              <input type="number" class="form-control col-auto des_price" id="coupon_discountxt" name="coupon_discountxt" placeholder="{{ __('keywords.coupon_discper_holder')}}" value="{{$coupon->amount}}" required>
                            </div>
                            <div class="col-md-4 offset-md-1">
                              <div class="form-group">
                                <p class="card-description">{{ __('keywords.Minimum Cart Value')}}</p>
                                <input type="number" name="cart_value" class="form-control mt-md-2" value="{{$coupon->cart_value}}" min="1" placeholder="{{ __('keywords.coupon_mincart_holder')}}">
                              </div>
                            </div>
                          </div>
                          <div class="row">
                            <div id="max_discount" class="col-md-4">
                              <div class="form-group">
                                ...
                                <input type="number" name="max_discountxt" id="max_discountxt" class="form-control" value="{{$coupon->max_discount}}" min="0" placeholder="{{ __('keywords.coupon_discmax_holder')}}">
                              </div>
                            </div>
                          </div>
    ...
    $("#discount_type").on('change', function(){
      ...
      if(discount_type=='percent'||discount_type=='amount'){
        ...
        if(discount_type!='percent'){
          ...
          $("#coupon_discountxt").attr('min', '1.0');
