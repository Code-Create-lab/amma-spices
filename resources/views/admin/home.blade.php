                ...
                <div class="col-sm-6 col-md-4 col-lg-2">
                    <div class="stats-card card-indigo">
                        <div class="card-content">
                            ...
                            <a href="javascript:void" class="card-link">
                    ...
                    <div class="stats-card card-orange">
                        <div class="card-content">
                            <div class="card-header-section">
                                ...
                                <div class="stats-value">{{ $totalConfimedOrder }}</div>
                            </div>
                            <a href="javascript:void" class="card-link">
                                <div class="card-footer-section">
                                    <span class="stats-label">Confirmed Orders</span>
                                    <i class="fas fa-arrow-right"></i>
                                </div>
                            </a>
                        </div>
                        ...
                        <table class="table table-borderless mb-0">
                            <thead>
                                <tr class="text-dark">
                                    ...
                                    <th>User Details</th>
                                    <th class="text-center">Order {{ __('keywords.Status') }}</th>
                                    <th class="text-right pr-0">Payment</th>
                                ...
                                @if (count($ongoin) > 0)
                                    ...
                                    @foreach ($ongoin as $ongoing)
                                        <tr>
                                            ...
                                            <td>
                                                {{-- @dd(  $ongoing->user->name) --}}
                                                <div class="ml-3 flex-grow-1">
                                                    <div class="font-weight-600 text-dark">
                                                        {{ $ongoing->user->name == '' ? $ongoing->address->receiver_name : $ongoing->user->name }}
                                                    </div>
                                                    <div class="fs-13px">({{ $ongoing->address->receiver_phone }} |
                                                        {{ $ongoing->user->email }})</div>
                                                </div>
                                            </td>
                                            ...
                                            <td class="text-right pr-0"> {{ $ongoing->payment_status }}</td>
                                                    ...
                                                    <table class="table">
                                                        <tr>
                                                            <td valign="top" style="width:50%">
                                                                ...
                                                                </strong>{{ $ords->user->phone }},
                                                                {{ $ords->user->email }}, @if ($ords->user_phone != $ords->receiver_phone)
                                                                    {{ $ords->receiver_phone }}
                                                                @endif <br />
