            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header card-header-primary">
                        <h4 class="card-title">{{ __('keywords.Cancel & Refund') }}</h4>
                        <form class="forms-sample" action="{{ route('updatecancelandrefundpolicy') }}" method="post"
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label>{{ __('keywords.Cancel & Refund') }}</label><br>
