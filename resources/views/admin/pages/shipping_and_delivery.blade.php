            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header card-header-primary">
                        <h4 class="card-title">{{ __('keywords.Shipping & Delivery') }}</h4>
                        <form class="forms-sample" action="{{ route('updateshippinganddeliverypolicy') }}" method="post"
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label>{{ __('keywords.Shipping & Delivery') }}</label><br>
