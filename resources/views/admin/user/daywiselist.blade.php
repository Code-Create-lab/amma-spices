                     ...
                     <div class="row">
                       ...
                       <div class="col-md-4">
                        <div class="form-group">
                          ...
                          <input type="date" name="sel_date" value="{{ request('sel_date') ?? $sel_date ?? '' }}" class="form-control">
                        </div>
                      </div>
                       <div class="col-md-4">
                        <div class="form-group">
                          <label>{{ __('keywords.To Date')}}</label><br>
                          <input type="date" name="to_date" value="{{ request('to_date') ?? $to_date ?? '' }}"  class="form-control">
                        </div>
                      </div>
     ...
     <tbody>
        ...
        <tr>
            ...
            <td> 
              ...
              {{-- <button type="button" data-toggle="modal" data-target="#exampleModal1{{$user->id}}"><i class="fa fa-credit-card" style="color:green;"></i></button>&nbsp; --}}
