                                    ...
                                    @if (count($ord) > 0)
                                        ...
                                        @foreach ($ord as $ords)
                                            <tr>
                                                ...
                                                @endif
                                                @if ($ords->order_status == 'Failed' || $ords->order_status == 'failed')
                                                    <td>
                                                        <p><span class="dot" style="color:red"></span><b
                                                                style="color:red">Failed</b></p>
                                                    </td>
                                                @endif
                        ...
                        <div class="card-body">
                            ...
                            @foreach ($address as $addresss)
                                <div class="container card">
                                    <b>{{ $addresss->type }} :</b>
                                    {{ $addresss->house_no }},{{ $addresss->society }},<br>
                                    @if ($addresss->landmark != null)
                                        {{ $addresss->landmark }},
                                        <br>
                                    @endif {{ $addresss->city }},{{ $addresss->state }},<br>
                                    {{ $addresss->pincode }}
                                </div><br>
                            @endforeach
                        </div>
                                                        ...
                                                        @if ($detailss->cart_id == $ords->cart_id)
                                                            <td>
                                                                <p><img style="width:25px;height:25px; border-radius:50%"
                                                                        src="{{ asset('storage/'.$detailss->varient_image) }}"
